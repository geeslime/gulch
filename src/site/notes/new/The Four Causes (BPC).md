---
{"dg-publish":true,"permalink":"/new/the-four-causes-bpc/","tags":["broad-physical-categories","metaphysics","physics"],"noteIcon":""}
---

<head>
  <title>The Four Causes (BPC)</title>
  <meta property="og:title" content="The Four Causes (BPC)" />
  ...
  <meta property="og:description" content="Aristotle's four causes reconceptualized...." />
  <meta property="og:locale" content="en_US" />
  <meta property="og:url" content="https://gulch.vercel.app/note/the-four-causes-bpc/" />
...
([[people/Aristotle\|Aristotle's]] **four causes** [[The Method of Cross-Conceptualization\|reconceptualized.]])

Just as there are [[new/Four Conditioning Connections (BPC)\|four conditioning connections]], there are **four species of causes** warranting special attention:

1. **Material Cause**: A *material conditioning connection* between an [[new/Entity and Property (BPC)\|entity]]'s [[new/Matter and Form (BPC)\|matter]] and its [[new/Action (BPC)\|actions]]. In other words, the kind of stuff something is *made of* affects the way it *acts*. If a steel sword *clashes* with an iron sword, it has a chance of *breaking* the iron sword.

2. **Formal Cause**: A *formal conditioning connection* between an [[new/Entity and Property (BPC)\|entity]]'s [[new/Matter and Form (BPC)\|form]] and its [[new/Action (BPC)\|actions]]. In other words, the [[new/Relationship (BPC)\|relationship]] between an [[new/Constituent and Composite Entities (BPC)\|entity's constituents]] conditions how the entity will act. In the case of [[isomers\|isomers]], different arrangements of [[atoms\|atoms]] led to different actions, namely different ways that these [[Chemical Compounds\|compounds]] chemically *interact* with other chemicals.

> One purpose of these two [[new/Broad Physical Categories (BPC)\|categories]] is to help direct the [[note/Science\|scientist]]'s attention towards *important* questions. If we ask, *"what is the formal cause of chemical reactions,"* then the case of isomers would actually show us that the spatial arrangement of atoms in a molecule plays a key role in *why* certain chemicals will or won't react with others. Now, why is that? . . .  *I don't know.* But, thanks to the [[note/Concept\|concept]] of **formal cause**, finding out is *now* on my to-do list. So it guided my attention towards a questioning worthy of answering.
>
...
3. **Efficient Cause**: A [[new/Conditioning Connections (BPC)\|conditioning connection]] between the [[new/Action (BPC)\|actions]] of a first entity and the [[new/Entity and Property (BPC)\|properties]] of a second entity. A block of marble has the shape it has because of the actions taken by the sculptor(this is the same example [[people/Aristotle\|Aristotle]] gave and this concept was not changed from his original conception).

4. **Passive Cause**: A [[new/Conditioning Connections (BPC)\|conditioning connection]] between the [[new/Entity and Property (BPC)\|properties]] of a first entity and the ways its other [[new/Entity and Property (BPC)\|properties]] will *change* when *subject to* the [[new/Action (BPC)\|actions]] of a second entity. Iif a [[note/Man\|man]] is in good health, he might survive poisons that would kill others. His health, a property, therefore *conditions* how the poison changes his other properties, *such as being alive or dead*.
...
>  ‎ ‎ ‎  ‎ ‎ ‎  ‎ ‎ ‎ ‎ ‎ ‎ ‎  ‎ ‎ ‎ ‎‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎  ‎ ‎ ‎ ‎ ‎ ‎ ‎  <iframe width="560" height="315" src="https://www.youtube.com/embed/YslpAB6D9Xo?si=vP0rWHiOh5jfHsTK&amp;start=3578" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<body>
  ...
  <script>
      var disqus_config = function () {
          this.page.url = "https://gulch.vercel.app/note/the-four-causes-bpc/";  // Replace with your page's canonical URL variable
