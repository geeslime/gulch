---
{"dg-publish":true,"permalink":"/new/broad-physical-categories-bpc/","tags":["broad-physical-categories","metaphysics","physics"],"noteIcon":""}
---
...
>
>Aristotle could see that the eclipse shadow was a circle, but it required [[inference\|inference]] to figure out that the Earth was a sphere. He had to reason from the fact that the Earth cast a circular shadow upon the moon regardless of the angle it cast that shadow. In general, by understanding the things that we see, [[concepts\|concepts]] allow us to [[deduce\|deduce]] our way to [[facts\|facts]] that we cannot see. Aristotle was able to reason from [[the nature of light\|the nature of light]], from the nature of a sphere, from the nature of the fact that it will block light in a certain way, and he was able to reason from these facts to deduce that the Earth had to be a sphere.
>
...
<center><h1>Broad Physical Categories Ordered by Subsumptive Relationships:</h1></center>
...
1. **[[note/Entity\|Entity]]**
    - **a.** [[new/Constituent and Composite Entities (BPC)\|Composite entity]]
    - **b.** [[new/Constituent and Composite Entities (BPC)\|Constituent entity]]
    - **c.** [[new/Material and Formal Entities (BPC)\|Material entity]]
    - **d.** [[new/Material and Formal Entities (BPC)\|Formal entity]]

2. **[[new/Characteristics vs. Properties (BPC)\|Characteristic]]**
    - **a.** [[new/Entity and Property (BPC)\|Property]]
        - **i.** [[new/Relationship (BPC)\|Relationship (BPC)]]
            - **1.** [[new/Action (BPC)\|Action]]
        - **ii.** [[new/Matter and Form (BPC)\|Matter]]
        - **iii.** [[new/Matter and Form (BPC)\|Form]]

    - **b.** [[new/Conditioning Connections (BPC)\|Conditioning Connection]]
        - **i.** [[new/Necessary Connections (BPC)\|Necessary Connection]]
        - **ii.** [[new/Four Conditioning Connections (BPC)\|Material conditioning]]
        - **iii.** [[new/Four Conditioning Connections (BPC)\|Formal Conditioning]]
        - **iv.** [[new/Four Conditioning Connections (BPC)\|Efficient Conditioning]]
        - **v.** [[new/Four Conditioning Connections (BPC)\|Passive Conditioning]]
        - **vi.** [[new/Four Conditioning Connections (BPC)\|Causal Connection]]:
            - **1.** [[new/The Four Causes (BPC)\|Material cause]]
            - **2.** [[new/The Four Causes (BPC)\|Formal cause]]
            - **3.** [[new/The Four Causes (BPC)\|Efficient cause]]
            - **4.** [[new/The Four Causes (BPC)\|Passive Cause]]
