---
{"dg-publish":true,"permalink":"/note/the-role-of-language-for-a-conceptual-being/","tags":["philosophy","epistemology"],"noteIcon":""}
---


<head>
  <title>The Role Of Language For A Conceptual Being</title>
  <meta property="og:title" content="The Role Of Language For A Conceptual Being" />
  ...
  <meta property="og:description" content="Concepts are formed by a process of abstracting out similar aspects among entities and then integrating these aspects into a new concept. In order to properly retain and be able to call up such..." />
  <meta property="og:locale" content="en_US" />
  <meta property="og:url" content="https://gulch.vercel.app/note/the-role-of-language-for-a-conceptual-being/" />
  <meta property="og:site_name" content="gulch" />
</head>

[[note/The Objectivist Theory of Concepts\|Concepts are formed]] by a process of [[note/Abstraction\|abstracting]] out similar aspects among entities and then [[note/Integration\|integrating]] these aspects into a new [[note/Concept\|concept]]. In order to properly retain and be able to call up such concepts at a moments notice, a conceptual being assigns a certain symbol to them---this is the role of language. I can call up the word "table" and immediately grasp the concept that it is standing in for---without this word such a task is impossible, without the word "table" I would have to re-abstract the relevant aspects from a number of concrete tables to bring the concept into focus. This is because concretes are the only things that actually exist---concepts do not, and cannot exist unto themselves. I must distil concepts down into something that is perceptually graspable, such as a word, or symbol, [[Art as a Concretisation of Philosophy\|or artwork]], in order that I can *objectify*[^1] the concept.

The role of [[note/Consciousness\|consciousness]], even on the [[Conceptual Consciousness\|conceptual level]], is to "look out"---[[note/Consciousness as a non-Entity\|consciousness is not an entity]] and cannot sustain itself within its own realm. Consciousness must always return to this primary task of perceiving [[note/Fact\|that which]] exists, rather than turning in on itself in a jumbled mess of abstractions without any clear or perhaps even existing concrete referents. 
...
<!-- Disqus Comments Section -->
  ...
  <script>
      var disqus_config = function () {
          this.page.url = "https://gulch.vercel.app/note/the-role-of-language-for-a-conceptual-being/";  // Replace with your page's canonical URL variable
          this.page.identifier = "the-role-of-language-for-a-conceptual-being"; // Replace with your page's unique identifier variable
      };
