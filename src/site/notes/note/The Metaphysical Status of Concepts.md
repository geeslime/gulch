---
{"dg-publish":true,"permalink":"/note/the-metaphysical-status-of-concepts/","tags":["philosophy","metaphysics","epistemology"],"noteIcon":""}
---


<head>
  <title>The Metaphysical Status Of Concepts</title>
  <meta property="og:title" content="The Metaphysical Status Of Concepts" />
  ...
  <meta property="og:description" content=">\[L]et us identify a problem in regard to concepts which has bedeviled philosophers from Greece to the present: what is the relationship of concepts to existents? To what precisely do concepts refer in reality?" />
  <meta property="og:locale" content="en_US" />
  <meta property="og:url" content="https://gulch.vercel.app/note/the-metaphysical-status-of-concepts/" />
  <meta property="og:site_name" content="gulch" />
</head>

>\[L]et us identify a problem in regard to [[note/Concept\|concepts]] which has bedeviled philosophers from Greece to the present: what is the relationship of concepts to existents? To what precisely do concepts refer in reality?[^1]

[[note/The Objectivist Theory of Concepts\|The formation of a concept]] involves a process of [[note/Abstraction\|abstraction]]---but these abstractions do not actually exist, so the problem at hand is: what, if anything, *is* a concept *in reality*?

[[people/Aristotle\|Aristotle]]'s answer was that:
...
The issue with such a view is that on the purely [[note/Sense Perception\|perceptual level]] there is no identity *between* different concretes that could serve as the basis for a concept. This is because [[note/The Law of Identity\|A is A]], not non-A---*that* dog is *that* dog, not *this* dog. There may be many similar aspects in common to dogs, but it could very easily be the case that every aspect changes in some minute way---each dog varies in its exact weight, its height, its breed, the length of its hair, the speed at which it can run, etc. In attempting to treat concepts *qua metaphysics* as referring to shared attributes between every item in the set, one is attempting to *equate* the different concretes in some way---you are not treating individual dogs "as more or less similar, but in some way as identical: as equally, interchangeably, members of the group."[^3]

[[people/Ayn Rand\|Ayn Rand]]'s solution to this problem is found in recognising the essential connection between the processes of conceptualisation and [[note/Measurement\|measurement]]:
...
<!-- Disqus Comments Section -->
  ...
  <script>
      var disqus_config = function () {
          this.page.url = "https://gulch.vercel.app/note/the-metaphysical-status-of-concepts/";  // Replace with your page's canonical URL variable
          this.page.identifier = "the-metaphysical-status-of-concepts"; // Replace with your page's unique identifier variable
      };
