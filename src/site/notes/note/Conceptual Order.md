---
{"dg-publish":true,"permalink":"/note/conceptual-order/","tags":["philosophy","epistemology"],"noteIcon":""}
---


<head>
  <title>Conceptual Order</title>
  <meta property="og:title" content="Conceptual Order" />
...
[[note/Concept\|Concepts]] can be seen as having a certain order (analogous to [[Capital Order\|the order of a capital good]] in [[notes/Economics\|economics]])---concepts of the first order are those that are [[note/The Objectivist Theory of Concepts\|formed directly from perceptual data]]. From this basis one is capable of abstracting further and forming *higher-level* concepts:

> A "first-level" concept, such as "table" or "man," is one formed directly from perceptual data. Starting from this base, concept-formation proceeds by a process of [[note/Abstraction\|abstracting]] *from abstractions*. The result is (increasingly) higher-level concepts, which cannot be formed directly from [[note/Percept\|perceptual data]], but only from earlier concepts. For example, a child may integrate first-level concepts into wider ones, which identify more extensive knowledge, such as integrating "cat," "dog," "horse" into "animal" (and later, "animal," "plant," "man" into "living organism"). Or he may subdivide first-level concepts into narrower ones, which identify more precise [[note/Differentiation\|differentiations]], such as subdividing "man" according to profession, into "doctor," "policeman," "teacher" (and later "doctor" into "children's doctor," "dentist," "surgeon," etc.).[^1]
...
[^1]: [[notes/OPAR\|notes/OPAR]]OPAR]], 91
[^2]: [[notes/OPAR\|notes/OPAR]]OPAR]], 91
...
<!-- Disqus Comments Section -->
  ...
  <script>
      var disqus_config = function () {
          this.page.url = "https://gulch.vercel.app/note/conceptual-order/";  // Replace with your page's canonical URL variable
          this.page.identifier = "conceptual-order"; // Replace with your page's unique identifier variable
      };
