...
<head>
  <title>Scientism</title>
  <meta property="og:title" content="Scientism" />
...
<!-- Disqus Comments Section -->
  ...
  <script>
      var disqus_config = function () {
          this.page.url = "https://gulch.vercel.app/note/scientism/";  // Replace with your page's canonical URL variable
          this.page.identifier = "scientism"; // Replace with your page's unique identifier variable
      };
